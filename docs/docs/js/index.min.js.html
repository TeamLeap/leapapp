      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="../../docs/js/index.min.js.html">docs/js/index.min.js</a></li>
          ...
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#$"><i class="alert alert-info"></i><span>$</span></a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="$">
            ...
            <p>
              <div class="label label-info radius ctx-type">method</div><span>&nbsp;</span><span>$()</span><span>&nbsp;</span>
            </p>
          </section>
          <div class="description"></div>
          <pre><code class="language-javascript">$(function(){var a=$(window);$(&quot;.scrollspy .nav&quot;).affix({offset:{top:function(){return a.width()&lt;=980?480:400},bottom:50}})});</code></pre>
        </div>
      </div>
    </div>
    <footer class="footer">
